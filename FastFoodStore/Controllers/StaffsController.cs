...
namespace FastFoodStore.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StaffID,Name,Role,PhoneNumber")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StaffID,Name,Role,PhoneNumber")] Staff staff)
        {
            if (ModelState.IsValid)
            {
