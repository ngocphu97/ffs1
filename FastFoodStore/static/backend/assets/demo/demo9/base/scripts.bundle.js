    ...
    */
    ...
    return {
        ...
        */
        ...
        /**
        * Gets highest z-product-group of the given element parents
        * @param {object} el jQuery element object
        * @returns {number}  
        */
...
(function($) {
	...
	$.fn.mDatatable = function(options) {
		...
		var Plugin = {
			...
			paging: function(meta, callback) {
				var pg = {
					...
					openPage: function(page) {
						// currentPage is 1-based product-group
			 ...
			 * @param tablePart
			 * @param row 1-based product-group
			...
			/**
			 * Sort table row at HTML level by column product-group.
			 * todo; Not in use.
			 ...
			 * @param index zero-based product-group
			 * @returns {jQuery}
			 */
        ...
        var Plugin = {
            ...
            */
            ...
            createSubmenuDropdownClickDropoff: function(el) {
                ...
                var dropoff = $('<div class="m-menu__dropoff" style="background: transparent; position: fixed; top: 0; bottom: 0; left: 0; right: 0; z-product-group: ' + zIndex + '"></div>');
                $('body').after(dropoff);
